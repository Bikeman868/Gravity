    ...
    internal class ValueGetter : IValueGetter
    {
        ...
        private void SetFunction(int scopeIndexValue)
        {
            switch (_scope)
            {
                ...
                default:
                    throw new Exception("ValueGetter does not know how to get " + _scope + "[" + scopeIndexValue + "] from the request");
            }
        }
        ...
        private void SetFunction(string scopeIndex)
        {
            switch (_scope)
            {
                ...
                default:
                    throw new Exception("ValueGetter does not know how to get " + _scope + "[\"" + scopeIndex + "\"] from the request");
            }
        }
        ...
        private void SetFunction()
        {
            switch (_scope)
            {
                ...
                default:
                    throw new Exception("ValueGetter does not know how to get " + _scope + " from the request when there is no index specified");
            }
        }
